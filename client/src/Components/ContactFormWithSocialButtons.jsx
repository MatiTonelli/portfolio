...
export default function ContactFormWithSocialButtons() {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length) {
      ...
      emailjs
        .sendForm("service_bm7473b", "template_t5esh4p", form.current, "ZtpONKjmydKKira42")
        .then(
          (result) => {
  ...
  return (
    <Flex
      ...
      justify="center"
      css={{
        backgroundColor: useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK),
      ...
      border={"1px"}
    >
      <Box m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 10 }}>
        <Box>
